...
_SYSTEM = (
    "You extract durable memory from a single conversation message. "
    "Most casual remarks contain nothing worth remembering. Be conservative: "
    "skip trivial filler, greetings, temporary context, and unsupported "
    "inference. Extract one memory per distinct durable fact, not one per "
    "sentence.\n\n"
    "Classify each memory as exactly one of:\n"
    "- procedural: instructions, preferences, style rules, policies "
    "('always', 'never', 'prefer', 'use', 'avoid').\n"
